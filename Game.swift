...
class Game {
    ...
    func generateInterests(person: Person) {
        ...
        for _ in 1 ... numberOfInterests {
            if let randomInterestNames = self.generateRandomInterestName () {
                let interest = Interest(randomInterestNames.displayName())
                print("  \(interest.name ) ")
                if !person.addInterest(interest) {
                    break
    ...
    func populateInterest() {
        print(" \n Our participants and their interests: \n")
    ...
    func logParticipants () {
        print ("\n Our participants introduction: \n") // our particpants introduction
